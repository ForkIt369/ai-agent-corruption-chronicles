...
/**
 * Test script to verify the new FinalAlith key connection
 * 
 * Usage:
 *   node scripts/test-new-fal-key.js
 */
...
async function testEndpoint(name, url) {
  console.log(`\n🧪 Testing ${name} endpoint with new FinalAlith key: ${url}`);
...
async function runTests() {
  console.log("🔍 Testing New FinalAlith Key");
  console.log("============================");
  ...
  console.log("\n📊 Test Summary");
  console.log("==============");
  console.log(`✅ ${successCount} of ${Object.keys(ENDPOINTS).length} endpoints working with new FinalAlith key`);
  ...
  if (successCount === 0) {
    ...
    console.log("🎉 All endpoints are working correctly with the new FinalAlith key!");
  }
}
